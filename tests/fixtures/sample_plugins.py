...
class MockSchemaPlugin(PluginInterface):
    ...
    def execute(self, context: PluginContext) -> PluginResult:
        return PluginResult(
            success=True,
            data={'validated': True, 'plugin': 'schema_mock'}
        )
...
class MockGuardPlugin(PluginInterface):
    ...
    def execute(self, context: PluginContext) -> PluginResult:
        return PluginResult(
            success=True,
            data={'approved': True, 'plugin': 'guard_mock'}
        )
...
class MockHealingPlugin(PluginInterface):
    ...
    def execute(self, context: PluginContext) -> PluginResult:
        return PluginResult(
            success=True,
            data={'recovered': False, 'plugin': 'healing_mock'}
        )
...
class MockReflectPlugin(PluginInterface):
    ...
    def execute(self, context: PluginContext) -> PluginResult:
        return PluginResult(
            success=True,
            data={'task_completed': True, 'plugin': 'reflect_mock'}
        )
...
class MockObservePlugin(PluginInterface):
    ...
    def execute(self, context: PluginContext) -> PluginResult:
        return PluginResult(
            success=True,
            data={'logged': True, 'plugin': 'observe_mock'}
        )
...
class AlternativeSchemaPlugin(PluginInterface):
    ...
    def execute(self, context: PluginContext) -> PluginResult:
        return PluginResult(
            success=True,
            data={'validated': True, 'plugin': 'schema_alternative'}
        )
